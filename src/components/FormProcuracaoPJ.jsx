...
export function FormProcuracaoPJ() {
  // Dados do Outorgante (Pessoa Jurídica)
  ...
  // Dados do Outorgado (Pessoa Física)
  ...
  const handleGeneratePreview = () => {
    ...
    const previewText = `PROCURAÇÃO\n\nOUTORGANTE: ${outorganteRazaoSocial}, inscrito sob o CNPJ: ${outorganteCnpj}, estabelecida em ${outorganteEndereco}.\n\nNOMEIO E CONSTITUO MEU BASTANTE PROCURADOR\n\nOUTORGADOS: ${outorgadoNome}, ${outorgadoNacionalidade}, maior, inscrito sob o CPF: ${outorgadoCpf}, residente e domiciliado em ${outorgadoEndereco}.\n\nREPRESENTAÇÃO: para fim especial, podendo vender para si e/ou para terceiros um ${veiculoNome}, Placa: ${veiculoPlaca}, RENAVAM: ${veiculoRenavam}, CHASSI: ${veiculoChassi}, ANO/MODELO ${veiculoAnoModelo}, cor ${veiculoCor}.\n\nLOCAL E DATA: ${localEmissao}, ${dataEmissao}.`;
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      const response = await fetch('https://5000-ixyxn6cw882c62cg2wx1q-7e1c4ba2.manusvm.computer/api/generate_procuracao_pj', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Gerar Procuração Pessoa Jurídica</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input id="outorganteCnpj" value={outorganteCnpj} onChange={(e) => setOutorganteCnpj(e.target.value)} placeholder="00.000.000/0000-00" />
          </div>
          <div>
            <Label htmlFor="outorganteEndereco">Endereço Completo</Label>
            <Input id="outorganteEndereco" value={outorganteEndereco} onChange={(e) => setOutorganteEndereco(e.target.value)} />
          </div>
        </div>

        {/* Outorgado (Pessoa Física) */}
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input id="outorgadoNacionalidade" value={outorgadoNacionalidade} onChange={(e) => setOutorgadoNacionalidade(e.target.value)} placeholder="brasileiro" />
          </div>
          <div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label htmlFor="veiculoNome">Nome do Veículo (conforme documento)</Label>
            <Input id="veiculoNome" value={veiculoNome} onChange={(e) => setVeiculoNome(e.target.value)} placeholder="Ex: VOLKSWAGEN/GOL 1.0" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="veiculoAnoModelo" value={veiculoAnoModelo} onChange={(e) => setVeiculoAnoModelo(e.target.value)} placeholder="Ex: 2019/2020" />
          </div>
          <div>
