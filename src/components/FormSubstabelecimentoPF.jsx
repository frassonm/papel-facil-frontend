...
export function FormSubstabelecimentoPF() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = 'substabelecimento_pf.pdf';
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Gerar Substabelecimento - Pessoa Física</h1>
