...
export function FormRepresentacaoPJ() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = 'representacao_pj.pdf';
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Gerar Procuração Representação na Compra - Pessoa Jurídica</h1>
