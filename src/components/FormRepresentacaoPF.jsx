...
// Texto padrão de poderes para Representação na Compra
const PODERES_REPRESENTACAO = "para fim especial efetuar a transferência, assinar de acordo no CRV, assinar como comprador na ATPV-e, emitir CRLV-e, assinar declaração de difícil acesso à coleta do número do motor, e declarar endereço em nome do OUTORGANTE\n\nEXEMPLOS DE CUSTOMIZAÇÃO:\n- PRAZO DE 30 DIAS\n- COM RETROAGIMENTO À DATA DE DD/MM/AAAA\n- VÁLIDA ATÉ DD/MM/AAAA";

export function FormRepresentacaoPF() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      const response = await fetch('https://5000-ixyxn6cw882c62cg2wx1q-7e1c4ba2.manusvm.computer/api/generate_representacao_pf', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = 'representacao_pf.pdf';
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Gerar Procuração Representação na Compra - Pessoa Física</h1>
