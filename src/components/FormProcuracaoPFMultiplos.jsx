...
export function FormProcuracaoPFMultiplos() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      const response = await fetch('https://5000-ixyxn6cw882c62cg2wx1q-7e1c4ba2.manusvm.computer/api/generate_procuracao_pf_multiplos', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = 'procuracao_pf_multiplos.pdf';
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Gerar Procuração Pessoa Física (Múltiplos Outorgados)</h1>
